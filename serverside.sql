...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2022 at 10:35 PM
...
(3, 3, 'Test Ring', 12, 'Type some words here to show a description test. There is no product so this will be fairly short. This test will be deleted so there is no point.', 30, '');
